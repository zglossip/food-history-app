  ...
  <ion-card class="filter-chips">
    <ion-card-content>
      <filter-chip-set
        ...
        @close="(course) => close({ type: FilterType.COURSE, value: course })"
      />
      <filter-chip-set
        ...
        @close="
          (cuisine) => close({ type: FilterType.CUISINE, value: cuisine })
        "
      />
      <filter-chip-set
        :elements="tags"
        ...
        icon-alt-text="Tag"
        @close="(tag) => close({ type: FilterType.TAG, value: tag })"
      />
    </ion-card-content>
  </ion-card>
</template>
